...
use Slim\Exception\HttpInternalServerErrorException as SlimHttpInternalServerErrorException;
    ...
    protected function respond(): Response
    {
        ...
        if ($exception instanceof HttpException) {
            $exceptionName = match (true) {
                ...
                $exception instanceof HttpExternalServiceUnavailableException => SlimHttpInternalServerErrorException::class,
                default => null
            };
